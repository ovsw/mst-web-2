      ...
      <section className={`${packageSlide} ${hero} ${packageSlide0}`}>
        <div className={packageSlide__contentWrapper}>
          <div className={packageSlide__content}>
            ...
            <img className={packageSlide__mobileImage} src='/images/programming/main-cover.png' alt='Mainstages Theater ina Box' />
          </div>
      ...
      <section className={`${packageSlide} ${hero} ${packageSlide1}`}>
        <div className={packageSlide__contentWrapper}>
          <div className={packageSlide__content}>
            ...
            <p className={packageSlide__undertitle}>Cultivate a successful program while simplifying your administrative schedule at the same time!</p>
            <img className={packageSlide__mobileImage} src='/images/programming/whole-adnotated.png' alt='Mainstages Theater ina Box' />
            <div className={bodyRte}>
              ...
              <ol>
                ...
                <li><strong>Afterschool Services:</strong> Session-based enrollment programs ideal for schools and organization</li>
              </ol>
      ...
      <section className={`${packageSlide} ${hero} ${packageSlide2}`}>
        <div className={packageSlide__contentWrapper}>
          <div className={packageSlide__content}>
            ...
            <p className={packageSlide__undertitle}>Success Starts With Great Staff!</p>
            <img className={packageSlide__mobileImage} src='/images/programming/base-adnotated.png' alt='Mainstages Theater ina Box' />
            <div className={bodyRte}>
              <p>We're dedicated to making sure your Theater Program has the best staff available! That's why we&nbsp;hand select your staff member&nbsp;from our pool of talented applicants&nbsp;based on applicable skills and relevant teaching experience</p>
              ...
              <ul>
                ...
                <li>possess a <strong>creative teaching style </strong>and innovative problem solving skill</li>
              </ul>
              <p>See details about Staffing &amp; Training:</p>
              <div className={packageSlide__buttonWrapper}>
                <Link className='button package-slide__button' to='/programming/camp-package/staffing-and-training/' sx={{variant: 'buttonsimpleAccent'}}>
                  Camp Staffing &amp; Training <FaChevronRight />
                </Link>
                <br />
                <Link className='button package-slide__button' to='/programming/afterschool-package/staffing-and-training/' sx={{variant: 'buttonsimpleAccent'}}>
      ...
      <section className={`${packageSlide} ${hero} ${packageSlide3}`}>
        <div className={packageSlide__contentWrapper}>
          <div className={packageSlide__content}>
            ...
            <p className={packageSlide__undertitle}>We Build the Infrastructure of Your Program!</p>
            <img className={packageSlide__mobileImage} src='/images/programming/back-adnotated.png' alt='Mainstages Theater ina Box' />
            <div className={bodyRte}>
              ...
              <ul>
                ...
                <li>Create lesson and activity plans that include an activities track for everyday periods and a performance track for clubs and intensive</li>
                <li>Develop itineraries and program outlines that build upon previous skills and application</li>
              ...
              <div className={packageSlide__buttonWrapper}>
                <Link className='button package-slide__button' to='/programming/camp-package/program-development/' sx={{variant: 'buttonsimpleAccent'}}>
                  Camp Program Development
                  <FaChevronRight />
                </Link>
                <br />
                <Link className='button package-slide__button' to='/programming/afterschool-package/program-development/' sx={{variant: 'buttonsimpleAccent'}}>
      ...
      <section className={`${packageSlide} ${hero} ${packageSlide4}`}>
        <div className={packageSlide__contentWrapper}>
          <div className={packageSlide__content}>
            ...
            <p className={packageSlide__undertitle}>Take in the applause with our stage and sound packages!</p>
            <img className={packageSlide__mobileImage} src='/images/programming/left-adnotated.png' alt='Mainstages Theater ina Box' />
            <div className={bodyRte}>
              ...
              <div className={packageSlide__buttonWrapper}>
                ...
                <Link className='button package-slide__button' to='/programming/camp-package/production-supplies/' sx={{variant: 'buttonsimpleAccent'}}>
                  Camp Production Supplies
                  <FaChevronRight />
                </Link>
                <br />
                <Link className='button package-slide__button' to='/programming/afterschool-package/production-supplies/' sx={{variant: 'buttonsimpleAccent'}}>
      ...
      <section className={`${packageSlide} ${hero} ${packageSlide5}`}>
        <div className={packageSlide__contentWrapper}>
          <div className={packageSlide__content}>
            ...
            <p className={packageSlide__undertitle}>We Ensure your Program Reaches Maximum Participation and Exposure!</p>
            <img className={packageSlide__mobileImage} src='/images/programming/right-adnotated.png' alt='Mainstages Theater ina Box' />
            <div className={bodyRte}>
              ...
              <div className={packageSlide__buttonWrapper}>
                ...
                <Link className='button package-slide__button' to='/programming/camp-package/marketing-and-publicity/' sx={{variant: 'buttonsimpleAccent'}}>
                  Camp Marketing &amp; Publicity
                  <FaChevronRight />
                </Link>
                <br />
                <Link className='button package-slide__button' to='/programming/afterschool-package/marketing-and-publicity/' sx={{variant: 'buttonsimpleAccent'}}>
      ...
      <section className={`${packageSlide} ${hero} ${packageSlide6}`}>
        <div className={packageSlide__contentWrapper}>
          <div className={packageSlide__content}>
            ...
            <p className={packageSlide__undertitle}>We're Involved on the Ground to Ensure Your Program Exceeds Expectations!</p>
            <img className={packageSlide__mobileImage} src='/images/programming/front-adnotated.png' alt='Mainstages Theater ina Box' />
            <div className={bodyRte}>
              <p>You'll receive active support&nbsp;in the day-to-day operations of your program to ensure succes</p>
              ...
              <ul>
                ...
                <li>Weekly resources and engagement opportunities for staff and participant</li>
              </ul>
              <p>See details about Supervision &amp; Support:</p>
              <div className={packageSlide__buttonWrapper}>

                <Link className='button package-slide__button' to='/programming/camp-package/supervision-and-support/' sx={{variant: 'buttonsimpleAccent'}}>
                  Camp Supervision &amp; Support
                  <FaChevronRight />
                </Link>
                <br />
                <Link className='button package-slide__button' to='/programming/afterschool-package/supervision-and-support/' sx={{variant: 'buttonsimpleAccent'}}>
