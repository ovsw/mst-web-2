...
const VideoHero = ({ data }) => {
  ...
  switch (video) {
    case 'performances1':
      videoSource =
        'https://mstvideo-ac97.kxcdn.com/mainstages-intro-montage.mp4';
      posterBg = '/images/hero-bg-live.jpg';
      heroType = 'Performances';
      break;
    case 'live1':
      videoSource =
        'https://lrw-ac97.kxcdn.com/mainstages-families-bg-video.mp4';
      posterBg = '/images/hero-bg-live.jpg';
      heroType = 'Live';
      break;
    default:
  ...
  return (
    ...
    >
      ...
      <div className={s.hero__content}>
        <Styled.h1 className={s.hero__heading} sx={{ color: 'primary' }}>
          {title}
        </Styled.h1>
        <div className={s.hero__hookline}>
          <BlockContent blocks={text} serializers={serializers} />
        </div>
        <Link
          className={s.hero__cta}
          to={url}
          sx={{
