...
const SEO = ({pagePath, metaInfo}) => {
  ...
  const ogImage = metaInfo ? metaInfo.openImage ? metaInfo.openImage : globalMetaInfo.openImage : globalMetaInfo.openImage
  const ogImageSrc = getOgImage(ogImage)
  const twitterImage = metaInfo ? metaInfo.twitterImageUrl ? metaInfo.twitterImageUrl : ogImage : ogImage
