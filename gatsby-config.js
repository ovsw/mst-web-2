  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        description:
          'mainstages provides virtual entertainment for families and organizations with interactive weekly classes for kids, variety shows, and online birthday parties!',
        start_url: '/',
